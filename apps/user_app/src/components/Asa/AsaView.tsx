import { Box, ButtonGroup, Divider, makeStyles, Paper, Typography } from '@material-ui/core';
  ...
  return (
    <Box>
      <Paper variant="elevation" elevation={8} className={classes.paper}>
        ...
        <Divider></Divider>
        <Typography className={classes.space} variant="h6">Balance: {balance >= 0 && balance} {asa.unitName}'s</Typography>
